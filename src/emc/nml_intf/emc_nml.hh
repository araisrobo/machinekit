...
/**
 * Set the Joint input_scale.
 **/
class EMC_JOINT_SET_INPUT_SCALE:public EMC_JOINT_CMD_MSG {
  public:
    EMC_JOINT_SET_INPUT_SCALE():EMC_JOINT_CMD_MSG(EMC_JOINT_SET_INPUT_SCALE_TYPE,
                                             sizeof(EMC_JOINT_SET_INPUT_SCALE))
    {
    };
