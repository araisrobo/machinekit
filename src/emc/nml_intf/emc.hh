...
#define EMC_JOINT_SET_INPUT_SCALE_TYPE                ((NMLTYPE) 133)
...
#define EMC_TRAJ_NURBS_MOVE_TYPE                     ((NMLTYPE) 240)
...
extern int emcJointSetInputScale(int joint, double input_scale);
...
extern int emcJointSetHomingParams(int joint, double home, double offset, double home_final_vel,
...
extern int emcJointSetSyncId(int joint, int sync_id);
...
extern int emcBypassFlags(void);
