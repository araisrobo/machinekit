...
#define VAL(X)  .value(#X, X)
	...
	.def_readwrite("pause_state", &EMC_TRAJ_STAT::pause_state )
        .def_readwrite("next_tp_reversed", &EMC_TRAJ_STAT::next_tp_reversed )
        .def_readwrite("cur_tp_reversed", &EMC_TRAJ_STAT::cur_tp_reversed )
        .def_readwrite("tp_reverse_input", &EMC_TRAJ_STAT::tp_reverse_input )
	...
	.def_readwrite("motion_type", &EMC_TRAJ_STAT::motion_type )
        ...
        .def_readwrite("prim_dtg", &EMC_TRAJ_STAT::prim_dtg )
        .def_readwrite("prim_progress", &EMC_TRAJ_STAT::prim_progress )
